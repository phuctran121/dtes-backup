  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 sm:px-8 lg:px-46 text-center ">
        <h2 className="text-4xl font-semibold mb-16 text-text-esg-title lg:block">
          RESULT
        </h2>
        ...
        <div className="hidden lg:grid grid-cols-3 gap-6 items-center">
          ...
          <div className="flex flex-col justify-center gap-6">
            {data.slice(0, 1).map((b, i) => (
              <WhyDTESBox key={i} title={b.title} text={b.text} result={true} />
            ))}
          </div>
          ...
          <div className="flex flex-col items-center gap-6">
            {data.slice(1, 3).map((b, i) => (
              <div key={i} className="w-full">
                <WhyDTESBox title={b.title} text={b.text} result={true} />
              </div>
            ))}
          </div>
