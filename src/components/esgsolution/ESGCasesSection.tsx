      ...
      <div className="container mx-auto px-4 sm:px-8 lg:px-46">
        ...
        <div className="mb-10 flex flex-col sm:flex-row justify-start items-start sm:items-center gap-10 md:gap-20 lg:gap-48">
          <div className="flex flex-col gap-2">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-semibold text-text-esg-title">
              <span className="">CASES</span>
            </h2>
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-semibold tracking-tighter">
              도입 사례
            </h2>
          </div>
          <p className="text-sm md:text-base lg:text-lg max-w-3xl font-medium leading-relaxed">
        ...
        {/* Cards Grid */}
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mt-14 md:mt-18 lg:mt-26">
          {data.map((card, index) => (
