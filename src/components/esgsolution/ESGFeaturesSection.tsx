...
export default function ESGFeaturesSection() {
  return (
    <section className="w-full py-20 md:py-28 bg-white">
      <div className="container min-h-screen sm:px-0 px-6 mx-auto md:px-8 lg:px-46 text-left">
        {/* Title */}
        <div className="mb-10 flex flex-col sm:flex-row justify-start items-start sm:items-center gap-10 md:gap-20 lg:gap-48">
          <div className="flex flex-col gap-1">
            <h2 className="text-2xl md:text-4xl font-bold text-text-esg-title">
              <span className="">FEATURES</span>
            </h2>
            <h2 className="text-xl md:text-4xl font-medium">5칸 카드</h2>
          </div>
