export default function ESGHeaderSection() {
  return (
    <section className="relative w-full">
      ...
      >
        {/* Overlay content */}
        <div className="h-full flex gap-24 md:gap-12 flex-col justify-center items-center text-center container sm:px-0 px-6 mx-auto py-32">
          {/* Top Title */}
          ...
          <div className="grid grid-cols-3 md:grid-cols-3 gap-10 w-full mt-38 items-center">
            <div className="flex flex-col items-start text-white sm:text-xl md:text-2xl lg:text-3xl text-left">
              <p className="">왜 ESG인가?</p>
