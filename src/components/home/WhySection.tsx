  ...
  return (
    <section className="w-full flex items-center py-16 md:py-24 border-t border-white/70">
      <div className="container mx-auto px-4 sm:px-8 lg:px-46 text-center">
        ...
        <p className="text-title-black text-sm sm:text-base md:text-lg max-w-2xl font-medium tracking-tight mx-auto mb-12 sm:mb-20 leading-snug">
        ...
        <div className="mt-16 sm:mt-20 lg:mt-24">
          <button className="bg-card-3 cursor-pointer hover:scale-105  text-white text-sm sm:text-base font-semibold px-6 sm:px-8 py-2.5 sm:py-3 rounded-full transition-all duration-200">
            서비스 문의하기 &gt;
          </button>
        </div>
      </div>
