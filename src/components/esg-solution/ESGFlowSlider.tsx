...
export default function ESGFlowSlider() {
  ...
  return (
    <section className="w-full min-h-screen gap-20 bg-[#F1F8FF] py-16 flex flex-col justify-center items-center overflow-hidden">
      <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold tracking-wide text-center mb-4 md:mb-10">
